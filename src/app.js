...
<head>
  ...
  <title>Unified AI Gateway — API aktif</title>
  <style>
    ...
    @media (prefers-color-scheme: dark) {
      .badge { background: #22c55e33; color: #4ade80; }
    }
    ...
    .muted { font-size: 0.8rem; opacity: 0.85; }
  </style>
</head>
<body>
  <p class="badge">Online</p>
  <h1>Unified AI Gateway</h1>
  <p>Backend API berjalan. Gunakan endpoint di bawah untuk cek atau integrasi.</p>
  <ul>
    <li><a href="/ping"><code>/ping</code></a> — cek cepat</li>
    <li><a href="/healthz"><code>/healthz</code></a> — status &amp; DB</li>
  </ul>
  <p class="muted">Respons halaman: ${startedAt}</p>
</body>
</html>`;
